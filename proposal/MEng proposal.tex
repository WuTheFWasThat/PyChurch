...
To specify value bindings, one can use randomness.  For example, I may declare in some program that {\tt x} is determined by a coin flip.  But on any given execution of the program, {\tt x} \vspace{6 pt}
